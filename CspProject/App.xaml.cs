    ...
    public partial class App : Application
    {
        ...
        private void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
            {
                ...
                // ✅ Configuration'dan debug ayarlarını oku
                var isDebug = ConfigurationService.Configuration["Sentry:Debug"] == "true";
                options.EnableSensitiveDataLogging(isDebug);
                options.EnableDetailedErrors(isDebug);
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            var sentryDsn = ConfigurationService.GetSentryDsn();
            var sentryEnvironment = ConfigurationService.Configuration["Sentry:Environment"] ?? "Production";
            var sentryDebug = ConfigurationService.Configuration["Sentry:Debug"] == "true";
            ...
            if (!string.IsNullOrWhiteSpace(sentryDsn))
            {
                SentrySdk.Init(o =>
                {
                    ...
                    o.TracesSampleRate = double.TryParse(ConfigurationService.Configuration["Sentry:TracesSampleRate"],
                        out var traces)
                        ? traces
                        : 1.0;
                    o.ProfilesSampleRate =
                        double.TryParse(ConfigurationService.Configuration["Sentry:ProfilesSampleRate"],
                            out var profiles)
                            ? profiles
                            : 1.0;
